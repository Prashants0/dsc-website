...
export const Route = createFileRoute("/partners")({
  ...
  head: () => ({
    meta: [
      {
        title:
          "Our Certifying Authorities | eMudhra, Capricorn, VSign, Pantasign, Safescrypt | SignSecure",
      },
      {
        name: "description",
        content:
          "SignSecure is an authorized reseller of India's top Certifying Authorities including eMudhra, Capricorn, VSign, Pantasign, and Safescrypt. CCA-approved Digital Signatures.",
      },
    ],
  }),
});
...
const AUTHORITIES = [
  ...
  },
  {
    ...
    tagline: "Reliable Digital Trust Partner",
    description:
      "VSign (Vindya Infosystems Pvt Ltd) is a CCA-licensed Certifying Authority providing secure digital signature certificates across India. VSign offers simple, dependable signing solutions perfect for both individual professionals and enterprises.",
    stats: [
      { label: "Processing Time", value: "< 1 hr" },
      { label: "Government Portals", value: "50+" },
      { label: "Pan India", value: "Yes" },
    ],
    certifications: ["CCA Licensed", "ISO Certified", "Government Approved"],
    products: ["Class 3 Individual DSC", "Class 3 Organization DSC", "Combo Certificates", "DGFT DSC"],
    website: "#",
    color: "brand-cobalt",
  },
  {
  ...
  },
  {
    ...
    tagline: "Sify's Trusted CA Brand",
    description:
      "Safescrypt (a Sify Technologies company) is one of India's oldest and most trusted Certifying Authorities, licensed by CCA. Backed by Sify's robust infrastructure, Safescrypt provides highly reliable digital signature certificates.",
    stats: [
      { label: "Years Active", value: "15+" },
      { label: "Enterprise Clients", value: "10K+" },
      { label: "Backed by", value: "Sify" },
    ],
    certifications: ["CCA Licensed", "ISO 27001", "Enterprise Grade", "Sify Infrastructure"],
    products: ["Class 3 Individual DSC", "Class 3 Organization DSC", "Encryption Certificates"],
    website: "#",
    color: "brand-cobalt",
  },
];
