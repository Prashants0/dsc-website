...
export const Route = createFileRoute("/products/foreign-national-dsc")({
  component: ForeignNationalDSCPage,
  head: () => ({
    meta: [
      {
        title:
      ...
      },
      {
        property: "og:title",
        content:
          "Foreign National & NRI Digital Signature Certificate | SignSecure",
      },
      {
        property: "og:description",
        content:
          "Digital Signature Certificate for Foreign Nationals & NRIs. Video KYC, passport verification, no Aadhaar needed. For overseas directors, NRI businesses & Indian filings.",
      },
      {
        property: "og:type",
        content: "product",
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Currently, only eMudhra (a CCA-licensed Certifying Authority) issues DSC for foreign nationals through video KYC. This is because eMudhra is the only CA that has invested in the video KYC infrastructure required by the Controller of Certifying Authorities (CCA) for non-Aadhaar verification. Other CAs like Capricorn, VSign, Pantasign, and Safescrypt primarily rely on Aadhaar eKYC and do not currently offer video-based verification for foreign nationals. eMudhra is India's largest Certifying Authority and is listed on the Bombay Stock Exchange (BSE) and National Stock Exchange (NSE), ensuring reliability and trust.",
  },
  {
...
const RELATED_PRODUCTS = [
  {
    ...
    price: "₹1,099",
    description:
      "Organization-level DSC for Indian companies. Aadhaar eKYC, issued in 30 minutes. Choose from 5+ Certifying Authorities.",
...
function ForeignNationalDSCPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://wa.me/919876543210?text=Hi%2C%20I%20need%20a%20Foreign%20National%20DSC"
                    target="_blank"
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none space-y-5 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                Capricorn, VSign, Pantasign, and Safescrypt currently only
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-8 sm:p-10">
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
                ...
                <p>
                  Other major CAs in India — Capricorn (CDAC), VSign, Pantasign,
                  and Safescrypt (Tata Communications) — currently support only
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              {PRICING.map(({ validity, price, mrp }, index) => (
                ...
                >
                  ...
                  <a
                    href={`https://wa.me/919876543210?text=Hi%2C%20I%20need%20Foreign%20National%20DSC%20-%20${encodeURIComponent(validity)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block"
                  >
        ...
        <section className="py-20 sm:py-28 bg-brand-navy text-white relative overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              ...
              <a href="mailto:support@signsecure.in">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-xl border-white/20 text-white hover:bg-white/10 h-12 px-8"
