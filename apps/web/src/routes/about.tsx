...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About SignSecure | Authorized Multi-CA DSC Reseller | Digital Signature India" },
      { name: "description", content: "SignSecure is India's trusted authorized reseller of Digital Signature Certificates. Multi-CA partner of eMudhra, Capricorn, VSign, Pantasign & Safescrypt. Selling DSCs and USB tokens since 2020." },
    ],
  }),
});
...
const MILESTONES = [
  ...
  { year: "2022", title: "Pan-India Reach", description: "Established doorstep delivery network across all states. Launched 24/7 WhatsApp support and added USB token sales." },
  { year: "2023", title: "5+ CA Partners", description: "Became one of the few resellers authorized by 5+ CAs including eMudhra, Capricorn, VSign, Pantasign & Safescrypt." },
...
const VALUES = [
  ...
  { icon: Heart, title: "Customer First", description: "We exist to make DSC procurement painless. 24/7 support, transparent pricing, and genuine care." },
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg text-white/55 leading-relaxed max-w-2xl mx-auto">
                ...
                with 5+ government-licensed Certifying Authorities and selling
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>As an authorized Registration Authority and reseller for eMudhra, Capricorn, VSign, Pantasign, and Safescrypt, plus authorized reseller of ePass 2003, Proxkey, MToken, TrustKey, and SafeNet 5100 tokens, we can offer what no single CA or token vendor can.</p>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="lg:order-2">
                ...
                <div className="space-y-4">
                  {[
                    { title: "Best Price Guarantee", desc: "We compare rates across 5+ CAs to always give you the most competitive price." },
                ...
                <div className="rounded-2xl border border-border bg-card overflow-hidden">
                  ...
                  <div className="p-6 space-y-4">
                    {[
                      ...
                      { name: "VSign", desc: "Simple, reliable signing solutions.", logo: "/assets/partner-vsign-favicon.png" },
                      { name: "Pantasign", desc: "Flexible, customizable DSC options.", logo: "/assets/partner-pantasign-white.svg" },
                      { name: "Safescrypt", desc: "Sify-backed. Enterprise-grade security.", logo: "/assets/partner-safescrypt.svg" },
                    ].map((partner) => (
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: Mail, label: "Email Us", value: "support@signsecure.in", href: "mailto:support@signsecure.in" },
                ...
                <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20">
                  ...
                  <div>
                    ...
                    <span className="text-sm font-semibold text-[#25D366]">+91 98765 43210</span>
                  </div>
                </a>
              </div>
            </div>
