...
export const Route = createFileRoute("/products/proxkey-usb-token")({
  component: ProxkeyUSBTokenPage,
  head: () => ({
    meta: [
      {
        title:
          "Buy Proxkey USB Token Online | FIPS Certified Crypto Token for DSC | SignSecure",
      },
      {
        name: "description",
        content:
          "Buy Proxkey USB Token online at ₹500. FIPS 140-2 Level 2 certified cryptographic USB token by WatchData Technologies. Compatible with all Certifying Authorities, government portals, and DSC types. Free shipping across India. Driver download available.",
      },
      {
        name: "keywords",
        content:
          "proxkey usb token, proxkey digital signature token, buy proxkey token online, proxkey token driver, watchdata proxkey, proxkey usb token price, proxkey crypto token, proxkey fips token, proxkey dsc token, buy proxkey token india",
      },
    ],
  }),
});
...
const TECH_SPECS = [
  { label: "Manufacturer", value: "WatchData Technologies (Beijing, China)" },
  { label: "Certification", value: "FIPS 140-2 Level 2" },
  { label: "Interface", value: "USB 2.0 (Type-A)" },
  { label: "Storage Capacity", value: "64KB EEPROM" },
  { label: "Key Size Supported", value: "RSA 1024 / 2048-bit" },
  {
    label: "Operating System",
    value: "Windows 7, 8, 8.1, 10, 11 | macOS | Linux",
  },
  { label: "Driver Installation", value: "Manual installation required" },
  { label: "Secure Chip", value: "WatchData proprietary secure chip" },
  { label: "Dimensions", value: "~6.5 cm × 1.8 cm × 0.9 cm" },
...
const COMPATIBLE_CAS = [
  ...
  {
    name: "VSign",
    description: "Government-approved CA with affordable pricing",
  },
  {
    name: "Pantasign",
  ...
  {
    name: "Safescrypt",
    description: "Sify subsidiary offering enterprise-grade DSC",
  },
];
...
const PROXKEY_ADVANTAGES = [
  ...
  },
  {
    ...
    description:
      "The Proxkey token is compatible with all five CCA-licensed Certifying Authorities in India — eMudhra, Capricorn, VSign, Pantasign, and Safescrypt. It works with every government portal including GST, Income Tax, MCA, EPFO, e-Tendering, and DGFT. Whether you have a Class 3 Signature, Encryption, or Combo DSC, the Proxkey token will store and serve it reliably.",
  },
  {
    icon: HardDrive,
...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, the Proxkey USB token is fully compatible with all five CCA-licensed Certifying Authorities operating in India — eMudhra, Capricorn, VSign, Pantasign, and Safescrypt. You can store a digital signature certificate from any of these CAs on the Proxkey token. The token supports the standard PKCS#11 and Microsoft CSP interfaces that all CAs use for certificate enrollment and storage. Whether you are buying a new DSC or transferring an existing one, the Proxkey token will work seamlessly.",
  },
  {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/919876543210?text=Hi%2C%20I%20want%20to%20buy%20a%20Proxkey%20USB%20Token"
                    target="_blank"
              ...
              <div className="hidden lg:block">
                <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm p-8">
                  <h2 className="font-display font-bold text-lg text-white mb-6 flex items-center gap-2">
                    <UsbIcon className="w-5 h-5 text-brand-cobalt-bright" />
                    Product Summary
                  </h2>
                  <div className="space-y-4">
                    {[
                      { label: "Product", value: "Proxkey USB Crypto Token" },
                      { label: "Manufacturer", value: "WatchData Technologies" },
                      { label: "Certification", value: "FIPS 140-2 Level 2" },
                      { label: "Interface", value: "USB 2.0 (Type-A)" },
                      { label: "Storage", value: "64KB EEPROM" },
                      { label: "Key Support", value: "RSA 1024 / 2048-bit" },
                      { label: "Driver", value: "Manual installation" },
                  ...
                  <div className="mt-6 pt-6 border-t border-white/[0.06]">
                    <div className="flex items-center gap-2 text-sm text-white/50">
                      ...
                      CCA-compliant for all DSC storage in India
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-6">
              ...
              <p className="text-base leading-relaxed">
                The Proxkey token is compatible with all five CCA-licensed
                Certifying Authorities operating in India — eMudhra, Capricorn,
                VSign, Pantasign, and Safescrypt. It works seamlessly with every
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                Complete hardware and software specifications of the Proxkey USB
                cryptographic token by WatchData Technologies.
              </p>
            </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-brand-navy text-white">
                      <th className="text-left font-display font-bold px-6 py-4 w-1/3">
                        Specification
                      </th>
