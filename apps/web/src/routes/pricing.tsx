  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Compare Digital Signature Certificate prices across eMudhra, Capricorn, VSign & more. Transparent pricing for Class 3 DSC, DGFT DSC, Combo certificates. Starting at Rs. 899.",
      },
    ],
  }),
});
...
const ADDONS = [
  ...
  { item: "WhatsApp + Phone Support", price: 0, label: "FREE", icon: Headset, description: "24/7 assistance via call or message." },
];

const COMPETITOR_COMPARE = [
  { feature: "Class 3 Org DSC (1 Year)", us: "Rs. 1,099", eMudhra: "Rs. 1,550", others: "Rs. 1,400 - 2,000", winner: true },
  { feature: "Multiple CA Options", us: "5+ CAs", eMudhra: "1 (Self)", others: "1-2 CAs", winner: true },
  ...
  { feature: "24/7 WhatsApp Support", us: "Yes", eMudhra: "Limited", others: "No", winner: true },
