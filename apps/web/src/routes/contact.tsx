...
export const Route = createFileRoute("/contact")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Contact SignSecure for DSC support, pricing queries, or partnership inquiries. 24/7 WhatsApp support. Mumbai-based authorized multi-CA reseller." },
    ],
  }),
});
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-base text-white/55 leading-relaxed max-w-xl mx-auto">
                Have questions about DSCs, USB tokens, or need help choosing the right certificate? Our experts are available 24/7.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-5 gap-10">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 rounded-xl bg-[#25D366]/[0.04] border border-[#25D366]/15 hover:bg-[#25D366]/[0.08] transition-colors group">
                  ...
                  <a href="tel:+919876543210" className="flex items-center gap-4 p-4 rounded-xl border border-border hover:border-brand-cobalt/20 transition-colors group">
                  ...
                  <a href="mailto:support@signsecure.in" className="flex items-center gap-4 p-4 rounded-xl border border-border hover:border-brand-cobalt/20 transition-colors group">
                    <div className="w-11 h-11 rounded-xl bg-brand-cobalt/[0.06] flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-foreground">support@signsecure.in</p>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl border border-border">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-foreground">24/7 (WhatsApp & Phone)</p>
