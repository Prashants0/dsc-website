...
export const Route = createFileRoute("/downloads")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Download USB token drivers, DSC utility tools, and setup guides. Drivers for ePass 2003, Proxkey, MToken, TrustKey & SafeNet 5100 tokens." },
    ],
  }),
});
          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="tel:+919876543210">
                <Button variant="outline" className="rounded-xl h-10 px-6">Call +91 98765 43210</Button>
              </a>
            </div>
          </div>
        </section>
