...
export const Route = createFileRoute("/products/class-3-individual-dsc")({
  component: Class3IndividualDSCPage,
  head: () => ({
    meta: [
      {
        title:
          "Buy Class 3 Digital Signature Certificate for Individuals | DSC for GST, ITR, MCA | SignSecure",
      },
      {
        name: "description",
        content:
          "Buy Class 3 Digital Signature Certificate for individuals online. Government-approved DSC for GST filing, Income Tax ITR, MCA ROC, e-Tendering & more. Aadhaar eKYC, 30-min delivery, free USB token. Starting ₹899. eMudhra, Capricorn, VSign, Pantasign & Safescrypt.",
      },
      {
        name: "keywords",
        content:
          "class 3 digital signature certificate, class 3 dsc for individuals, buy class 3 dsc online, individual digital signature for gst, dsc for income tax filing, class 3 dsc price, digital signature for mca filing, dsc for gst registration, buy dsc online india",
      },
    ],
  }),
});
...
const CA_OPTIONS = [
  ...
  },
  {
    ...
    description:
      "Government-approved Certifying Authority offering affordable DSCs with fast eKYC-based issuance across India.",
  },
  {
    id: "pantasign",
    name: "Pantasign",
  ...
  },
  {
    ...
    description:
      "A subsidiary of Sify Technologies and a CCA-licensed authority, Safescrypt offers secure and trusted DSC solutions.",
  },
];
...
const APPLICATION_STEPS = [
  {
    ...
    description:
      "Select your preferred Certifying Authority (eMudhra, Capricorn, VSign, Pantasign, or Safescrypt) and choose the validity period — 1, 2, or 3 years based on your needs.",
    time: "2 minutes",
  },
  {
    step: 2,
...
const KEY_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Our DSC support team is available round the clock via WhatsApp, phone, and email. Get help with installation, portal configuration, or any technical issues.",
  },
];
...
function Class3IndividualDSCPage() {
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mb-8">
                  <span className="text-xs text-white/50 font-medium block mb-2">
                    Available from 5 CCA-licensed authorities:
                  </span>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/919876543210?text=Hi%2C%20I%20want%20to%20buy%20a%20Class%203%20Individual%20DSC"
                    target="_blank"
        ...
        <section className="py-20 sm:py-28 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="text-muted-foreground text-base leading-relaxed">
                We offer Class 3 Individual DSCs from 5 CCA-licensed Certifying
