  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Explore our complete range of Digital Signature Certificates. Class 3 Individual & Organization DSC, DGFT DSC for Import/Export, Combo certificates, USB Tokens and more. Authorized reseller of eMudhra, Capricorn, VSign, Pantasign & Safescrypt.",
      },
    ],
  }),
});
...
const PRODUCT_CATEGORIES = [
  {
    ...
    authorities: ["eMudhra", "Capricorn", "VSign", "Pantasign", "Safescrypt"],
...
const USB_TOKENS = [
  ...
  {
    name: "SafeNet 5100 Token",
    brand: "Thales",
    logo: "/assets/token-safenet-logo.png",
    price: 1200,
    description: "Enterprise-grade USB token from Thales. Preferred by large organizations.",
    features: ["Enterprise grade", "Thales chip", "FIPS 140-2 L3", "Premium build"],
    popular: false,
    detailHref: "/products/safenet-5100-usb-token",
  },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative py-20 sm:py-28 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.06] border border-white/[0.08] mb-6">
                ...
                <span className="text-xs font-semibold text-white/80 tracking-wide uppercase">
                  Authorized Reseller of 5+ Certifying Authorities
                </span>
              </div>
              ...
              <p className="text-lg text-white/55 leading-relaxed mb-8 max-w-2xl mx-auto">
                As an authorized reseller of eMudhra, Capricorn, VSign,
                Pantasign & Safescrypt, we offer the widest selection of
            ...
            <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { value: "5+", label: "Certifying Authorities" },
        ...
        {/* USB Tokens Section */}
        <section id="usb-tokens" className="py-20 sm:py-28 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              {USB_TOKENS.map((token) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Link to={token.detailHref} className="flex-1">
                      <Button
                        variant="outline"
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  icon: Headset,
                  title: "24/7 Support",
                  desc: "WhatsApp, phone & email support round the clock",
                },
                {
                  icon: BadgeCheck,
                  title: "5+ Certifying Authorities",
                  desc: "Choose from eMudhra, Capricorn, VSign, Pantasign & more",
                },
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-muted-foreground text-base leading-relaxed mb-8 max-w-xl mx-auto">
              Our DSC experts are available 24/7 to help you choose the right
