...
const FAQ_DATA = [
  ...
  },
  {
    ...
    answer:
      "Yes, SignSecure provides complete support for MToken setup and configuration. Our support team can help you with driver installation, DSC import, PIN management, portal configuration, and troubleshooting. You can reach us via WhatsApp at +91 79907 40623 (available online), phone call, or email. We also provide step-by-step video guides and documentation on our Downloads page for self-service setup.",
  },
];
...
export default function MTokenUSBTokenPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20an%20MToken%20USB%20Token"
                    target="_blank"
...
className="rounded-xl bg-transparent border-white/20 text-white hover:bg-white/10 hover:text-white dark:bg-transparent dark:border-white/20 dark:hover:bg-white/10 h-12 px-8"
              ...
              <div className="hidden lg:block">
                <TokenBulkPricingCard tokenName="MToken" singlePrice={500} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground leading-relaxed space-y-6">
              ...
              <p className="text-base leading-relaxed">
                ...
                Authorities in India — including eMudhra, Capricorn, Pantasign,
                and SignX. It works on all major government
        ...
        <TokenBulkPricingSection tokenName="MToken" singlePrice={500} />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      ...
                      our support team is available online via WhatsApp.
                    </p>
                  </div>
                </div>
              </div>
