...
const ADVANTAGES = [
  {
    ...
    description:
      "The ePass 2003 is supported by all Certifying Authorities in India and works seamlessly with every government portal that accepts DSCs. No other token has this level of universal compatibility.",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "eMudhra, Capricorn, Pantasign, and SignX all recommend and support the ePass 2003 as their primary USB token. Their download utilities and certificate management tools are optimized for this device.",
  },
  {
...
export default function EPass2003Page() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20an%20ePass%202003%20USB%20Token"
                    target="_blank"
...
className="rounded-xl bg-transparent border-white/20 text-white hover:bg-white/10 hover:text-white dark:bg-transparent dark:border-white/20 dark:hover:bg-white/10 h-12 px-8"
              ...
              <div className="hidden lg:block">
                <TokenBulkPricingCard tokenName="ePass 2003" singlePrice={500} />
              </div>
            </div>
          </div>
        </section>
        ...
        <TokenBulkPricingSection tokenName="ePass 2003" singlePrice={500} />
