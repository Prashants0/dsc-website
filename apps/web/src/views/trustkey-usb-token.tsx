...
export default function TrustKeyUSBTokenPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20a%20TrustKey%20USB%20Token"
                    target="_blank"
...
className="rounded-xl bg-transparent border-white/20 text-white hover:bg-white/10 hover:text-white dark:bg-transparent dark:border-white/20 dark:hover:bg-white/10 h-12 px-8"
              ...
              {/* Right: Bulk Pricing Card */}
              <div className="hidden lg:block">
                <TokenBulkPricingCard tokenName="TrustKey" singlePrice={600} />
              </div>
            </div>
          </div>
        </section>
        ...
        <TokenBulkPricingSection tokenName="TrustKey" singlePrice={600} />
            ...
            <div className="mt-8 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-saffron/[0.06] border border-brand-saffron/15">
                ...
                <span className="text-sm font-medium text-brand-saffron">
                  Need help with installation? WhatsApp us at +91 79907 40623
