...
export default function Class3ComboDSCPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20Class%203%20Combo%20DSC"
                    target="_blank"
            ...
            <div className="max-w-4xl mx-auto rounded-xl bg-amber-500/[0.04] border border-amber-500/15 p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Pantasign and SignX currently issue only
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="mt-10 text-center">
              ...
              <a
                href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20apply%20for%20Class%203%20Combo%20DSC"
                target="_blank"
                rel="noopener noreferrer"
              >
