...
const PRICING_DATA = [
  ...
  { ca: "SignX", y1: 1099, y2: 1549, y3: 1999 },
];
...
const KEY_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Choose from 4 government-licensed Certifying Authorities — eMudhra, Capricorn, Pantasign, or SignX — based on your preference and budget.",
  },
  {
    icon: Zap,
...
export default function Class3OrganizationDSCPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20Class%203%20Organization%20DSC" target="_blank" rel="noopener noreferrer">
                    <Button
                      size="lg"
              ...
              {[
                {
                  ...
                  description:
                    "Choose your preferred Certifying Authority (eMudhra, Capricorn, Pantasign, or SignX) and select 1, 2, or 3-year validity period.",
                },
                {
                  step: "02",
                  icon: Upload,
        ...
        <section className="relative py-20 sm:py-28 overflow-hidden">
          ...
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-10">
              <a
                href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20Class%203%20Organization%20DSC"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
