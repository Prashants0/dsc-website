...
export default function SafeNet5100USBTokenPage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <a
                    href="https://wa.me/917990740623?text=Hi%2C%20I%20want%20to%20buy%20a%20SafeNet%205100%20eToken"
                    target="_blank"
...
className="rounded-xl bg-transparent border-white/20 text-white hover:bg-white/10 hover:text-white dark:bg-transparent dark:border-white/20 dark:hover:bg-white/10 h-12 px-8"
              ...
              <div className="hidden lg:block">
                <TokenBulkPricingCard tokenName="SafeNet 5100" singlePrice={1200} />
              </div>
            </div>
          </div>
        </section>
        ...
        <TokenBulkPricingSection tokenName="SafeNet 5100" singlePrice={1200} />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-8">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  href="https://wa.me/917990740623?text=Hi%2C%20I%20need%20help%20installing%20SafeNet%20Authentication%20Client"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button
