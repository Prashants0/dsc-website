...
import View from "@/views/mtoken-usb-token";

export const metadata: Metadata = {
  title:
    "Buy MToken USB Crypto Token Online | Compact DSC Token | SignSecure",
  description:
    "Buy MToken USB crypto token online in India. Compact, lightweight FIPS-certified digital signature token at just Rs. 500. Compatible with all CAs — eMudhra, Capricorn, SignX. Works on all government portals. Doorstep delivery across India.",
  keywords:
